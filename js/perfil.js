...
function carregarPerfis() {
 ...
 cards.innerHTML +=
    <div class="card rounded-4">
        ...
        <i
            class='bx bxs-plus-circle rouded-4 d-flex justify-contente-center align-items-center flex-fill'></i>
...
function adicionarPerfil(){
    ...
    perfis.push(perfil);
    localStorage.setItem("murilofilmes-users", JSON.stringify(perfis));
...
function exibirPainelPerfil() {
    ...
    divEdicao.classList.remove('d-flex');
    divEdicao.classList.add('d-none');
    let divExcluir = document.querySelector('.exclui');
